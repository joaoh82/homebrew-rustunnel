...
This project shares its knowledge base with its parent (rustunnel). Do **not** create a separate `Projects/homebrew-rustunnelcli/` folder — entries about this child go in the parent's vault.
